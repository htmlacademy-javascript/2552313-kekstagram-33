...
const getComment = (minAvatarValue, maxAvatarValue, commentId) => ({
  id: commentId,
  avatar: `img/avatar${randomInteger(minAvatarValue, maxAvatarValue)}.svg`,
  message: MESSAGE[randomInteger(0, MESSAGE.length - 1)],
...
const getPost = (minLikes, maxLikes, commentSpace, minCommentAmount, maxCommentAmount, minAvatarValue, maxAvatarValue) => {
  ...
  return {
    ...
    comments: Array.from({ length: randomInteger(minCommentAmount, maxCommentAmount) }, () =>
